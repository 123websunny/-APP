<template>
	<div style="width: 100%;height: 100%;margin: 0;padding: 0;background-color: #fff;position:relative;">
		<Header title="生活服务"></Header>
		<div class="content">
			<div id="map" class="map">
				<router-link to="/shfwSearch">
					<div class="search">
						<mt-search placeholder="请输入搜索内容"></mt-search>
					</div>
				</router-link>

				<div class="layer">
					<!--@click="showLayer"-->
					<img src="../../../static/img/layer.png" /> 图层
				</div>
				<div class="detail" v-show="showInfoWindow">
					<el-row>
						<el-col :span="16">
							<div class="title">逸夫楼</div>
							<p>简介：楼层5层，主要包含30个教室和3个阶梯教室</p>
						</el-col>
						<el-col :span="8" class="r-review">
							<div class="browes" @click="showGroup=true">
				...
				<div class="layergroup" v-show="showGroup">
					<el-col :span="6">
						<img src="../../../static/img/111.png" /> 2D地图
					</el-col>
					<el-col :span="6">
						<img src="../../../static/img/222.png" /> 2.5D地图
					</el-col>
					<el-col :span="6">
						<img src="../../../static/img/333.png" /> 3D地图
					</el-col>
					<router-link to="/shfwContent">
						<el-col :span="6">
							<img src="../../../static/img/444.png" /> 全景地图
						</el-col>
					</router-link>
